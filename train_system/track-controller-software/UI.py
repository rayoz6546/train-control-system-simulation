# -*- coding: utf-8 -*-
"""
Created on Wed Feb 22 22:56:17 2023
...
class ui(QtWidgets.QMainWindow):
    ...
    def setupUi(self):
        self.setObjectName("Track Controller Manual")
        self.resize(300, 300)
        ...
        self.label_ss = QtWidgets.QLabel(self.tab)
        ...
        self.label_occ = QtWidgets.QLabel(self.tab)
        self.label_occ.setFont(font)
        self.label_occ.setObjectName("label_occ")
        self.horizontalLayout.addWidget(self.label_occ)
    ...
    def retranslateUi(self):
        ...
        self.setWindowTitle(_translate("MainWindow", "Track Controller Manual"))
        ...
        self.label_21.setText(_translate("MainWindow", "Track Occupancy"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("MainWindow", "Edit Output"))
    ...
    def _update(self):
        ...
        self._track_controller.set_commanded_speed(self.lineEdit_3.text(),self.block,self.line_)
        ...
        self.label_auth.setText(_translate("MainWindow", str(self._track_controller.get_authority()[self.line_][self.block])))
        self.label_ss.setText(_translate("MainWindow", str(self._track_controller.get_suggested_speed()[self.line_][self.block])))
        if self._track_controller.get_track_occupancy()[self.b] == True:
            self.label_occ.setText(_translate("MainWindow", "Yes"))
        elif self._track_controller.get_track_occupancy()[self.b] == False:
            self.label_occ.setText(_translate("MainWindow", "No"))
        else:
            self.label_occ.setText(_translate("MainWindow", ""))
